      ...
      <p>
        ...
        list. A mind.
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQEgsum2RFfIG4la54g6vlz4xZQqpzyJvLagrH3AynLjTQCh2lI2mL0MmZQ6nenEmSemrI60OMgKkWAr-KCbmexLq6fIZJhsEJ05gvW55xoSxm1pkEN7iEgClPqm8g_zLZv0KUWLkTFf34VugPQ=" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Endangered Languages Statistics — Lingobright</a></li>
            ...
            <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQGz58KBI-o27Dh7SLjODhHszm2qx-IHR8EvoNjvigw6NgO7uTI-U-r2iWN10IkYl0FVNNzJPmyoRMHnq9sFNd7COhxhdHri5nm-HifIKUbAEBVewdIc01K8_hLNZMaWigbXkADhjig8xZzulq55EVBF4nKNVeI7uZcM95VgWFsFwqjp1RCQ9clYiNE2nJVdsBVqzSKtJHACglhmeDJ668RIMt6C5v2cYoWzvFGYB-2kVvAs0aG0N9f6xC9IYHQCJNZMlC7kd9UoFfXz_37OK047" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Tevfik Esenç and Ubykh Recordings — Kuban State University</a></li>
            ...
            <li id="src-xv"><span className="text-muted/50 mr-2">xv.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQHDtZ2rvmZJfZXkQBUe5XFPO3Qr2Itf9w8Q4ForDRpTTU6bTtLAT1ar_os3TCxTVQdrDLqj8vK0r92A_bnKxYJ9a68CGJbEDIBBZqKwB6ahmVCG2ZwnufTP_J2ctwmaErZ7" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Lera Boroditsky — How Language Shapes Thought (UCSD)</a></li>
            <li id="src-xvi"><span className="text-muted/50 mr-2">xvi.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQGactw9I_87ZK1WQo9Taze3-fi7F0ADI1FbIPeOmSrjI4yUAIx0YEEkBhfK3ijqGUatFOmWBXQkeGlt7PRVVvGrevBleUmQOn0YT1lt5GYXBVM7wLonxUlenlfuYwS1ruoUSmvw7ycF1Kw_dQG2CVY=" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Evidentiality in Tuyuca and Amazonian Languages — Alta Lang</a></li>
            <li id="src-xvii"><span className="text-muted/50 mr-2">xvii.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQEsq_Vfo8g7rZuDJdiwnR2CltBQqNDrSRI-Vsfjuj13yaR6L4hAfTfdzE13OQ71oxqw_JRhhyH3zu4cK-cmkl_6vl8_Dgx3sB9T3-Yby1cVLZFFnNcczjVujl4Hvg33R7TzdVWXX2exNPyMYBM=" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Robin Wall Kimmerer on the Grammar of Animacy</a></li>
            <li id="src-xviii"><span className="text-muted/50 mr-2">xviii.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQEPUMPIlXKneIjfu6OpKSgfx99lupg3DtLtlPz8TPI-i7gVMDPRlKDuqAGI8EaC848Rav8Hz4EN5vVQcBVuQUqY1940Emjap9wbw7DJYM02R5HwYCsuxm6aUQPxv0iMMystTY3aKSMg8Hpnu8CJFEUzg0dz-IFsnZ_6_1mhzdliZObG6D4=" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Language Loss Threatens Medicinal Plant Knowledge — EcoWatch / PNAS Study</a></li>
            <li id="src-xix"><span className="text-muted/50 mr-2">xix.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQHPEImLgsd0A3P62yXaETKdk18U_44gDdynHAmMgLV1RKmv8La2iGZmByZQU2KZDgcpLQPOSeAR6CytJoNsPZIcz1koT-whbTWtJwYSJX-876emM--LmV2kQ8ls8mAPblFbqTgFVcmq8LaSoA30kGyrazO9hhuf0aLabGKkcI5RiODbhrtZtkyra5iNOYLSvP07T3uususEB2m2IDZfEEp8SW6cxEn7OiROa6Xi" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Endangered Language Documentation Expeditions — ResearchGate</a></li>
            <li id="src-xx"><span className="text-muted/50 mr-2">xx.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQEjzmTcbKXyWZaShIvGB6iAN6Do7By1vz87vIAjlW2dwyIp-uXGqkXT50MKFaoM1YPhbaGC0v_L0bfDW8UYFgJNvy0FdcxwoniSvua1GaHaFivBQgKTDZx-H8gViVsq2f1cuncCBVusb1oPmSBkQkuwwxjXafgeizcgFBE8QC8=" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Michael Krauss on Linguistic Extinction — Swarthmore</a></li>
            <li id="src-xxi"><span className="text-muted/50 mr-2">xxi.</span> <a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQGO0Medh6VL59iY0i4TwjqGz1zBSnSodRrX3s0jK4bx8xFzUW17V-2SNruiRlGbHsJc83Y7t8gouaMl182vuUXd8qm1n3lrUeLXbyRneqdr0XFlU9rjzep6rCn0E8ZYtRXaNAEEKL-dvdnrDg==" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">AI and the Digital Language Divide — Quantumrun</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
