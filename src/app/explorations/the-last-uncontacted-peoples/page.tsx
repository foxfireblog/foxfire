...
export default function TheLastUncontactedPeoples() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="15 min"
    audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-last-uncontacted-peoples.opus"
    ><article>
      ...
      <p>The Ayoreo-Totobiegosode of Paraguay&apos;s Gran Chaco, believed to be the only uncontacted tribe in South America outside the Amazon basin, are a devastating case study.<sup><a href="#src-iv" className="text-muted/50 hover:text-foreground no-underline transition-colors">iv</a></sup> In 1979 and again in 1986, the American fundamentalist group New Tribes Mission (now rebranded as Ethnos360, as if a name change could launder history) organized what can only be described as manhunts&mdash;armed expeditions into the forest to flush Ayoreo groups into the open for the purpose of evangelization. The people who escaped deeper into the Chaco did so because they had watched what happened to those who didn&apos;t. A man named Parojnai Picanerai spent his entire life on the run from bulldozers clearing his forest for cattle ranches. &ldquo;We ran from one place to another,&rdquo; he said after his family finally emerged in 1998, exhausted and terrified. &ldquo;It looked like the bulldozer was following us.&rdquo; Shortly after making contact, Parojnai contracted a respiratory disease from outsiders and died.<sup><a href="#src-vi" className="text-muted/50 hover:text-foreground no-underline transition-colors">vi</a></sup></p>

      <p>This is the pattern. This has always been the pattern. When the British arrived in the Andaman Islands in the 1850s, the Great Andamanese numbered around 5,000 people. Today, fewer than 50 remain&mdash;a 99% population collapse driven overwhelmingly by disease.<sup><a href="#src-viii" className="text-muted/50 hover:text-foreground no-underline transition-colors">viii</a></sup> Survival International reports that it is common for up to 50% of an isolated tribe to be wiped out by foreign illnesses like influenza or measles within the first year of contact.<sup><a href="#src-vii" className="text-muted/50 hover:text-foreground no-underline transition-colors">vii</a></sup> Not the first decade. The first year. The common cold, to an immune system that has never encountered it, can be an extinction event.</p>
      ...
      <p>The last uncontacted peoples are not relics. They are not living fossils, or museum exhibits, or content waiting to be captured. They are people who have made a choice that the rest of us find almost incomprehensible, and that incomprehension is our problem, not theirs. The most ethical thing we can do&mdash;the hardest, most counterintuitive, most genuinely radical thing&mdash;is to let the door stay closed. To let the no be a no. To let the forest keep its secrets. And to turn our attention, with whatever moral seriousness we can summon, to the bulldozers, the ranchers, the tanneries, the supply chains, the YouTubers, and the missionaries&mdash;all the forces that keep trying to pry the door open, each convinced that what they carry through it is a gift.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://news.mongabay.com/2025/01/calls-for-protection-as-new-images-emerge-of-uncontacted-amazonian-tribe/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">news.mongabay.com</a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://petapixel.com/2024/12/27/photos-taken-on-remote-cameras-reveal-uncontacted-tribe-in-amazon-rainforest/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">petapixel.com</a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://www.businessinsider.com/drone-footage-shows-amazon-tribe-no-outside-world-contact-2018-8" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.businessinsider.com</a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://www.refworld.org/reference/countryrep/mrgi/2008/64334" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Paraguay : Ayoreo&quot;</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.survivalinternational.org/tribes/ayoreo" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Paraguay : Ayoreo&quot; Exact URL: https://www.refworld.org/reference/countryrep/mrgi/2008/64334 Source: Survival International – &quot;Ayoreo Tribe Profile&quot;</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.wrm.org.uy/bulletin-articles/living-on-the-run-devastation-of-the-ayoreos-lives-and-land-at-the-hands-of-livestock-farmers" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.wrm.org.uy</a></li>
            <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span> <a href="https://www.survivalinternational.org/news/10134" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.survivalinternational.org</a></li>
            <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span> <a href="https://www.survivalinternational.org/tribes/great-andamanese" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Today, fewer than 50 remain—a 99% collapse driven overwhelmingly by disease. Source: Survival International – &quot;Great Andamanese Tribe Profile&quot;</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
