...
export default function PaperTowns() {
  return (
    ...
    >
      ...
      <p>In the 1975 edition of the <em>New Columbia Encyclopedia</em>, between real entries for real things, the editors inserted a biography. Lillian Virginia Mountweazel, born 1942 in Bangs, Ohio. A fountain designer turned photographer. She received government grants to photograph &ldquo;New York City buses, the cemeteries of Paris, and rural American mailboxes.&rdquo; Her book of mailbox photographs was titled <em>Flags Up!</em> She died at the age of thirty-one &ldquo;in an explosion while on assignment for <em>Combustibles</em> magazine.&rdquo;</p>
