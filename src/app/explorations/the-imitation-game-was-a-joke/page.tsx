...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Imitation%20Game%20Was%20a%20Joke&category=Essay&color=violet&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheImitationGameWasAJoke() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://www.turing.org.uk/publications/testbook.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Alan Turing: The Enigma — Andrew Hodges (via turing.org.uk)</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Computing_Machinery_and_Intelligence" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Computing Machinery and Intelligence — Alan Turing, 1950 (Wikipedia)</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://www.cs.sfu.ca/~oschulte/teaching/320-09/turing.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Robin Gandy on Turing&apos;s 1950 paper as &ldquo;propaganda&rdquo; (SFU)</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Andrew Hodges on Turing, homosexuality, and the theme of &ldquo;passing&rdquo; (The Guardian)</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://www.history.com/articles/alan-turing" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Alan Turing: conviction, chemical castration, and death (History.com)</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://en.wikipedia.org/wiki/ELIZA" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">ELIZA — Wikipedia</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://www.salon.com/2003/02/26/loebner_part_one/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Weizenbaum&apos;s secretary and the ELIZA effect (Salon)</a></li>
      ...
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://www.salon.com/2003/02/26/loebner_part_one/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Minsky on the Loebner Prize (Salon)</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://plato.stanford.edu/archives/sum2017/entries/chinese-room/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">John Searle, &ldquo;Minds, Brains, and Programs&rdquo; — Chinese Room argument (Stanford Encyclopedia of Philosophy)</a></li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><a href="https://today.ucsd.edu/story/ai-can-seem-more-human-than-real-humans-in-a-classic-turing-test-study-finds" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Jones &amp; Bergen, &ldquo;AI Passes the Turing Test&rdquo; — PNAS, May 2026 (UC San Diego)</a></li>
      </ol>
