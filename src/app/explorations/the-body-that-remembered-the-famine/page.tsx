...
export default function TheBodyThatRememberedTheFamine() {
  return (
    ...
    >
      ...
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://pubmed.ncbi.nlm.nih.gov/18955703/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Heijmans et al., Persistent Epigenetic Differences (2008) — PNAS</a></li>
