...
export default function TheScrambleForAfrica() {
  return (
    ...
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Thomas Pakenham, <em>The Scramble for Africa</em> &mdash; Oxford University Press</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>General Act of the Berlin Conference, Article 35 &mdash; SDSU</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>General Act of the Berlin Conference, Article 6 &mdash; AfroLegends</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>The Rudd Concession &mdash; Zimbabwe Field Guide</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>King Lobengula Quotes &mdash; QuoteFancy</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>King Lobengula&apos;s Envoys to Queen Victoria &mdash; AfroLegends</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Hilaire Belloc, <em>The Modern Traveller</em> &mdash; African Poems</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Arbitrary Borders in Africa &mdash; AfroLegends</li>
