...
export default function TheBookNoOneCanRead() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="6 min"
    audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-book-no-one-can-read.opus"
    >
      ...
      <p>
        Maybe that is the message.
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://www.history.com/news/voynich-manuscript-mystery-contents" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The History Channel</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.britannica.com/topic/Voynich-manuscript" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Encyclopedia Britannica</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://en.wikipedia.org/wiki/Voynich_manuscript" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Voynich Manuscript</a></li>
            <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span> <a href="https://news.artnet.com/art-world/voynich-manuscript-sex-women-2486955" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Artnet News</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
