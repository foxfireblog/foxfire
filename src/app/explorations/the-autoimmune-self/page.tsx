...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Autoimmune%20Self&category=Essay&color=rose&readTime=14%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheAutoimmuneSelf() {
  return (
    ...
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://ricosbiology.net/journal/article/view/131/267" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">AIRE Gene and Thymic Negative Selection &mdash; Rico&apos;s Biology</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://www.longdom.org/open-access/molecular-mimicry-of-host-glycans-in-infection-and-autoimmunity-103791.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Molecular Mimicry in Autoimmune Disease &mdash; Longdom Publishing</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://www.researchgate.net/publication/360082799_Dual_autoimmune_diseases_Rheumatoid_arthritis_with_systemic_lupus_erythematosus_and_Type_1_diabetes_mellitus_with_multiple_sclerosis" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Shimon Sakaguchi and the Discovery of Regulatory T-cells &mdash; ResearchGate</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://www.nobelprize.org/prizes/medicine/2025/sakaguchi/facts/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">2025 Nobel Prize in Physiology or Medicine &mdash; NobelPrize.org</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC10066346/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Short-Chain Fatty Acids and Immune Regulation &mdash; NIH</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://www.grahamrook.net/resources/Rook_autoimmunity_11.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Graham Rook&apos;s &ldquo;Old Friends&rdquo; Hypothesis &mdash; GrahamRook.net</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://med.stanford.edu/news/all-news/2024/02/women-autoimmune.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Xist RNA and Sex-Biased Autoimmunity &mdash; Stanford Medicine</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://www.drugdiscoverynews.com/on-the-cusp-of-a-car-t-cell-cure-for-lupus-16120" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">CAR-T Cell Therapy for Autoimmune Disease &mdash; Drug Discovery News</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://constructivist.info/13/1/151.cohen" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Francisco Varela&apos;s Immune Cognitive Network Theory &mdash; Constructivist Foundations</a></li>
      </ol>
