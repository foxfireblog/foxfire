...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Hunger%20Artists&category=Essay&color=amber&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheHungerArtists() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Merlatti&apos;s 50-day fast in Paris, 1886 — Cambridge University Press</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Dr. Henry Tanner&apos;s 40-day fast — Art of Manliness</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>The medical monitoring of Tanner&apos;s fast — Health Science</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Giovanni Succi&apos;s fasting career — Cambridge University Press</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Succi&apos;s &ldquo;Yanos water&rdquo; and performance habits</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Fasting girls and anorexia mirabilis — Brill</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>The tragedy of Sarah Jacob — History Extra</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Scientific study of fasting performers — Cambridge University Press</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Corporate sponsorship of Tanner&apos;s fast</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Kafka&apos;s &ldquo;A Hunger Artist&rdquo; — The Kafka Project</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><a href="https://en.wikipedia.org/wiki/Above_the_Below" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">David Blaine&apos;s 2003 Thames stunt — Wikipedia</a></li>
      </ol>
