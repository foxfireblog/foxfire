...
export default function TheInterpreterAtTheEndOfTheWorld() {
  return (
    ...
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://vertexaisearch.cloud.google.com/grounding-api-redirect/AUZIYQGQgZRsw-SVTLW2_xfGeeoLbDpUpIzaobaqNFU4Z_BJvAu1JHXMifvsYHTV024axDrX99dQ7zOKY8DZTex1ILa7L_xO9asYlJl03xkis22oEYqP3vmuhtR-BTJW_h0rQrZ-u3hG2otu0Vqv5-kfGOX--p9e7gxwzDG0oLFA1loQjDe5Rz9g" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Canada History: The Truchements &mdash; French Colonial Interpreters</a></li>
