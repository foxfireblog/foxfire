...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Cabinet%20of%20Dr.%20Blumenbach&category=Essay&color=amber&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheCabinetOfDrBlumenbach() {
  return (
    ...
    >
      ...
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><a href="https://doi.org/10.1007/978-1-4684-9063-3_14" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Lewontin, &ldquo;The Apportionment of Human Diversity&rdquo; (1972) — Springer</a></li>
