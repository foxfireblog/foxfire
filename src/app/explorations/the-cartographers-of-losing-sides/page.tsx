...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Cartographers%20of%20Losing%20Sides&category=Essay&color=amber&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheCartographersOfLosingSides() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="13 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-cartographers-of-losing-sides.opus"
    >
