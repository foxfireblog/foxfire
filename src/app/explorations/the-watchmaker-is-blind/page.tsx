...
export default function TheWatchmakerIsBlind() {
  return (
    ...
    >
      ...
      <p>Here is a fact that should stop you in your tracks: a protein of just 100 amino acids has roughly 10<sup>300</sup> possible ways to fold. If it tried one new configuration every picosecond&mdash;a trillionth of a second&mdash;it would take 10<sup>27</sup> years to stumble upon the right one. The universe is 13.8 billion years old. That&apos;s 1.38 × 10<sup>10</sup> years. The protein would need a span of time so vast it makes the entire history of the cosmos look like a camera flash.</p>

      <p>And yet, right now, inside your body, proteins are folding correctly in microseconds. Millions of them. Constantly. Without a blueprint, without a foreman, without anyone watching. They simply fall into shape, guided down what biochemists call an &ldquo;energy landscape funnel&rdquo;&mdash;the laws of thermodynamics doing quietly what no designer could do fast enough. Cyrus Levinthal pointed this out in 1969 and called it a paradox. But it&apos;s only a paradox if you assume the protein is searching randomly. It isn&apos;t. Physics has opinions. Matter has preferences. The universe is not neutral about shape.</p>
