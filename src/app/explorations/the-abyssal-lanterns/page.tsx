...
export default function TheAbyssalLanterns() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://oceanexplorer.noaa.gov/ocean-fact/bioluminescence/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">NOAA: Bioluminescence in the Deep Ocean</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>UC Santa Barbara: Bioluminescence evolved at least 94 times independently</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Smithsonian: Bioluminescence origin dated to 540 million years ago (2024 study)</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Malacosteus niger far-red bioluminescence and retinal photosensitizer mechanism</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Cookie-cutter shark counterillumination and the &ldquo;dog collar&rdquo; lure hypothesis</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Ostracod bioluminescent defense in cardinalfish predation</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Kleptoluminescence: dietary acquisition of bioluminescent chemistry</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Edith Widder, the Medusa lander, and the first giant squid footage</li>
      </ol>
