...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Hafnium%20Bomb&category=Essay&color=amber&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheHafniumBomb() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Hafnium isomer triggering experiment details and Collins&apos; lab setup</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Nuclear isomer physics, hafnium-178m2 energy properties and quantum mechanics</li>
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Pentagon Militarily Critical Technologies List and DARPA SIER program details</li>
      ...
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Peter Zimmerman&apos;s role, dirty bomb analysis, and JASON review commissioning</li>
