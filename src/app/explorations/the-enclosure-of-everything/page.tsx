...
export default function TheEnclosureOfEverything() {
  return (
    ...
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Common Rights in the Medieval Manor &mdash; Llanbadoc.org</li>
      ...
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>English Enclosure Acts &mdash; British History Society</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Inclosure Consolidation Act 1801 and its effects &mdash; Fhithich.uk</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>The Captain Swing Riots &mdash; Age of Revolution</li>
