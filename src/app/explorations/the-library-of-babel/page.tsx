...
export default function TheLibraryOfBabel() {
  return (
    ...
    >
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://web.mit.edu" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Seth Lloyd, Computational Capacity of the Universe — MIT</a></li>
