...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Pale%20Astronaut&category=Essay&color=sky&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function ThePaleAstronaut() {
  return (
    ...
    >
      ...
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://pubmed.ncbi.nlm.nih.gov/30975860/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">NIH/PubMed — Telomere Dynamics in the NASA Twins Study</a></li>
