...
export default function TheRubberHandIllusion() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-rubber-hand-illusion.opus"
    >
      ...
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Lush (2020) &mdash; demand characteristics critique of the rubber hand illusion</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Blom et al. (2016) &mdash; BIID/xenomelia and reduced premotor cortex activity</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Depersonalization-derealization and increased susceptibility to body ownership illusions</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Predictive coding, Friston&apos;s free energy principle, and the minimal phenomenal self</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Neuroprosthetics and the rubber hand illusion &mdash; synchronous nerve stimulation for limb integration</li>
      </ol>
