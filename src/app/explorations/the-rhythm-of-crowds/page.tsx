...
export default function TheRhythmOfCrowds() {
  return (
    ...
    >
      ...
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://doi.org/10.1038/229244a0" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">McClintock (1971), Menstrual Synchrony and Suppression — Nature / NIH</a></li>
