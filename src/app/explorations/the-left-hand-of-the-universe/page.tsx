...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Left%20Hand%20of%20the%20Universe&category=Essay&color=violet&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheLeftHandOfTheUniverse() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Murchison Meteorite: Enantiomeric Excess in Extraterrestrial Amino Acids</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Isovaline Enantiomeric Excess in Carbonaceous Chondrites (NIH)</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Pasteur&apos;s 1848 Discovery of Molecular Chirality</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Biot and Pasteur: The Verification of Molecular Chirality</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://en.wikipedia.org/wiki/Thalidomide" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Thalidomide: Racemization and the Enantiomer Trap (Wikipedia)</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Dr. Frances Oldham Kelsey and the Thalidomide Crisis</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>The Frozen Accident Hypothesis and Biological Homochirality</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>The Vester-Ulbricht Hypothesis: Parity Violation and Chirality</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>The Soai Reaction: Asymmetric Autocatalysis and Amplification</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Circularly Polarized Light in the Orion Nebula Star-Forming Region</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>UCLA Study: RNA Shows No Inherent Preference for L-Amino Acids (2024)</li>
      </ol>
