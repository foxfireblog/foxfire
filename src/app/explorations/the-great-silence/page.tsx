...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Great%20Silence&category=Essay&color=indigo&readTime=15%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheGreatSilence() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="14 min"
    audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-great-silence.opus"
    >
