...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=Before%20Time%20Zones&category=Essay&color=amber&readTime=12%20min",
        width: 1200,
        height: 630,
