...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Zone%20of%20Alienation&category=Natural%20History&color=emerald&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheZoneOfAlienation() {
  return (
    ...
    ><h2>The Forest That Ate a City</h2>
      ...
      <p>The numbers are startling, and they keep getting more startling. A 2015 study published in <em>Current Biology</em> by Jim Smith and colleagues found that populations of elk, roe deer, red deer, and wild boar within the Exclusion Zone were comparable to those in uncontaminated nature reserves across the region. The wolf population was seven times higher than in surrounding areas. Seven times.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup> Przewalski&apos;s horses, introduced in 1998 as part of a rewilding experiment, have thrived.<sup><a href="#src-v" className="text-muted/50 hover:text-foreground no-underline transition-colors">v</a></sup> European bison wander through abandoned villages. Lynx have been spotted. There are persistent, credible reports of brown bears&mdash;animals that hadn&apos;t been seen in the region for over a century.</p>
      ...
      <p>The filmmaker Holly Morris documented some of these women in her 2015 documentary <em>The Babushkas of Chernobyl</em>, and their testimony is devastating and oddly joyful. They eat food from contaminated gardens. They drink water from contaminated wells. They have, by every medical standard, made an irrational choice. And yet&mdash;and this is documented&mdash;the self-settlers who returned to the Zone consistently outlived those who were relocated.<sup><a href="#src-vi" className="text-muted/50 hover:text-foreground no-underline transition-colors">vi</a></sup> Not by a little. By years. The relocated residents, torn from their homes, their communities, their identities, their daily rhythms, died of heart disease and depression and alcoholism at rates that dwarfed any realistic radiation risk. The babushkas who went home ate radioactive potatoes and survived.</p>
      ...
      <p>The Zone of Alienation will outlast most of us. Plutonium-239, present in the soil and the sarcophagus, has a half-life of 24,100 years. That means the Zone will still be measurably contaminated when whatever civilization follows ours is itself a ruin. And in that contaminated soil, things will still be growing&mdash;strange things, adapted things, things that found a way to make a life in conditions we declared unlivable. I find this neither hopeful nor hopeless. I find it true. And sometimes truth, unadorned and ungoverned by narrative, is the most generous thing a place can offer.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://doi.org/10.1016/j.cub.2015.08.017" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://doi.org/10.1098/rsbl.2007.0136" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://doi.org/10.1098/rsbl.2008.0778" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://doi.org/10.1371/journal.pone.0000457" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://doi.org/10.1007/s13364-019-00445-y" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">(This study specifically tracks the success of the 36 horses originally released between 1998 and 2004).</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.bbc.com/news/science-environment-30209616" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.bbc.com</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
