...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Tulsa%20Race%20Massacre&category=History&color=red&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheBurningOfBlackWallStreet() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="11 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-burning-of-black-wall-street.opus"
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://www.hrw.org/news/2020/05/29/case-reparations-tulsa-oklahoma" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Human Rights Watch &mdash; The Tulsa Race Massacre</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Smithsonian Institution &mdash; Greenwood District History</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>WNYC Studios &mdash; The Tulsa Tribune and the Missing Editorial</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>The Guardian &mdash; Tulsa Race Massacre Coverage</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Justice for Greenwood &mdash; B.C. Franklin Manuscript and Survivor Testimonies</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>City of Tulsa &mdash; 2001 Race Riot Commission Report</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>AP News &mdash; Internment of Survivors and Green Tags</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Express-News &mdash; Insurance Riot Clauses and the Economic Aftermath</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Deutsche Nationalbibliothek &mdash; Economic Analysis of the Racial Wealth Gap</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>State Court Report &mdash; Oklahoma Supreme Court Dismissal of Survivors&apos; Lawsuit (2024)</li>
      </ol>
