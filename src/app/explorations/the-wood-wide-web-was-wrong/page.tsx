...
export default function TheWoodWideWebWasWrong() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="13 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-wood-wide-web-was-wrong.opus"
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>MycoStories — The Wood Wide Web in Popular Culture</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Mycorrhizal_network" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia — Mycorrhizal Networks</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>The Guardian — Profile of Suzanne Simard</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>University of Alberta — Karst et al. 2023 Review</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>MycoStories — Carbon Transfer Evidence Reviewed</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>The Guardian — The &ldquo;Wood Wide Web&rdquo; Debate</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>The Guardian — Karst&apos;s Motivation for the Review</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Earth.com — Positive Citation Bias in Mycorrhizal Research</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>India Today — The Simard-Karst Conflict of Interest Dispute</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Sierra Club — How Mycorrhizal Fungi Actually Work</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>Kathryn Flinn — &ldquo;The Idea That Trees Talk to Cooperate Is Misleading&rdquo; (Scientific American)</li>
      </ol>
