...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Winchester%20Mystery%20House&category=Essay&color=violet&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
    ...
    ><h2>The Nails Left Half-Driven</h2>
      ...
      <p>I think that&apos;s the real mystery of the Winchester House. Not whether it&apos;s haunted, but why we so desperately need it to be. Why we&apos;d rather have a madwoman obeying ghosts than a grieving genius building something she loved. The answer, I suspect, is that the second version is sadder. It means the labyrinth wasn&apos;t guilt. It was just love, looking for a shape it could survive in. And it never found one. And she kept building anyway.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://upress.missouri.edu/9780826222701/captive-of-the-labyrinth/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">upress.missouri.edu</a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://firearmsresearchcenter.org/haunted-by-the-past-the-real-story-of-sarah-winchester/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">firearmsresearchcenter.org</a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://winchestermysteryhouse.com/history/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">winchestermysteryhouse.com</a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://winchestermysteryhouse.com/sarah-winchesters-story/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">It also confirms the legend of the &quot;unbroken construction&quot; that supposedly only halted the day she died—a lore feature heavily promoted by the estate today, which includes the famous &quot;half-driven nails&quot; left by carpenters upon hearing of her death.</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.nps.gov/places/winchester-house.htm" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.nps.gov</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.biography.com/history-culture/sarah-winchester" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">It also notes that those who actually knew her considered her exceptionally bright, possessing a sharp mind for architecture and finance, aligning with the article's claim that her lawyer and foreman rejected the narrative that she was insane.</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
