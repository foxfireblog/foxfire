...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Centennial%20Light&category=Essay&color=amber&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheCentennialLight() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-centennial-light.opus"
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Prof. Debora Katz&apos;s Research on the Centennial Light&apos;s Carbon Filament</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>The Centennial Light: Semiconductor Properties &amp; Webcam Ironies</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>The Phoebus Cartel: History, Members, and Enforcement Mechanisms</li>
      ...
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>GE&apos;s Sherman Anti-Trust Conviction &amp; Cartel Dissolution</li>
      ...
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Brooks Stevens on Dynamic Obsolescence &mdash; Quotes and Context</li>
      </ol>
