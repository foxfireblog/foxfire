...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Dancing%20Plague&category=Historical%20Inquiry&color=red&readTime=14%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheDancingPlague() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
    audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-dancing-plague.opus"
    ><article>
      <h2>The Woman Who Would Not Stop</h2>

      <p>Here is a fact: on or around July 14, 1518, a woman named Frau Troffea stepped out of her half-timbered house onto a narrow cobblestone street in Strasbourg and began to dance. There was no music. No festival, no celebration, no apparent joy. She simply began to move&mdash;her body twisting and lurching in the summer heat, her feet striking the cobblestones in a rhythm only she could hear. Her husband begged her to stop. She did not stop. She danced for six days.<sup><a href="#src-vi" className="text-muted/50 hover:text-foreground no-underline transition-colors">vi</a></sup></p>

      <p>Within a week, thirty-four people had joined her. Within a month, the number swelled to roughly four hundred. They danced until their feet swelled and blistered, until the blisters burst, until blood seeped through their leather boots and wooden clogs. Many of them wept as they danced. They cried out for mercy, for help, for release from the thing their bodies were doing without their permission. Their eyes were glassy, vacant, fixed on something no witness could see. They were, by every account, entirely unwilling participants in their own movement.<sup><a href="#src-iv" className="text-muted/50 hover:text-foreground no-underline transition-colors">iv</a></sup></p>
      ...
      <p>Sometimes I think that&apos;s what all inexplicable behavior is: a signal in a frequency we haven&apos;t learned to decode. The laughing children of Tanganyika. The ticking teenagers on TikTok. The woman on the cobblestones in the brutal heat, her husband pleading, her feet bleeding, her body speaking the only truth it knew how to speak. We look at these events and we want the ergot, the molecule, the clean explanation. But the clean explanation is a lute at a private wedding&mdash;the thing we allow ourselves because it doesn&apos;t threaten us. The truth is the drum. The truth is the tambourine. The truth is the thing that pulls you onto the stage in the horse market whether you want to go or not. The truth is that we are, all of us, more porous than we believe, more connected than we admit, more capable of being moved by forces we cannot name than any Enlightenment framework is comfortable with. Frau Troffea knew this. Or rather, her body knew it. She never stopped trying to tell us.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(09" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The Lancet (Academic Medical Journal) URL:</a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://pubmed.ncbi.nlm.nih.gov/19231571/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">pubmed.ncbi.nlm.nih.gov</a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://www.bps.org.uk/psychologist/dancing-plagues-and-mass-hysteria" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The British Psychological Society URL:</a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://www.nationalgeographic.com/history/article/dancing-plague-of-1518-strasbourg-choreomania" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">National Geographic URL:</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.history.com/news/what-was-the-dancing-plague-of-1518" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">History.com (A&E Television Networks) URL:</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.britannica.com/event/dancing-plague-of-1518" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Encyclopaedia Britannica URL:</a></li>
            <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span> <a href="https://search.worldcat.org/title/213380482" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">WorldCat (Underlying Academic Text) URL:</a></li>
            <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span> <a href="https://bigthink.com/the-past/dancing-plague-middle-ages/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Big Think (Historical Analysis) URL:</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
