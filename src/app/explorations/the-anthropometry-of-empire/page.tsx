...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Anthropometry%20of%20Empire&category=Essay&color=red&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheAnthropometryOfEmpire() {
  return (
    ...
    >
      ...
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Risley and the Nasal Index in Colonial India — sreenivasaraos.com</li>
