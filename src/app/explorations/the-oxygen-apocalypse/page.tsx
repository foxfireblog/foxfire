...
export default function TheOxygenApocalypse() {
  return (
    ...
    >
      ...
      <p>To understand what oxygen destroyed, you have to understand what came before it. For roughly two billion years&mdash;from the formation of Earth around 4.5 billion years ago to the GOE around 2.4 billion years ago&mdash;our planet was an alien world. The atmosphere was thick with methane, carbon dioxide, ammonia, and water vapor. There was virtually no free molecular oxygen. The sky, if you could have stood beneath it (you couldn&apos;t; you would have asphyxiated and been irradiated simultaneously), was probably some shade of hazy orange, the methane scattering sunlight into a perpetual chemical twilight.</p>

      <p>The oceans were stranger still. They were anoxic&mdash;devoid of dissolved oxygen&mdash;and packed with dissolved ferrous iron. Picture water with a faint greenish-black tint, warm, acidic, and chemically restless. In these waters lived the rulers of early Earth: the methanogens, archaea that metabolized hydrogen and carbon dioxide and exhaled methane. They were among the first metabolizers, the original breathers in a world where &ldquo;breathing&rdquo; meant something entirely different from what we mean now. They fed the methane greenhouse that kept the planet warm despite a sun that was roughly 20 to 25 percent dimmer than it is today. Life and atmosphere were locked in a feedback loop: methanogens warmed the world, and the warm world fed the methanogens.</p>
