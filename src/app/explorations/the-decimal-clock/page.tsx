...
export default function TheDecimalClock() {
  return (
    ...
    >
      ...
      <p>The Republican Calendar was officially mandated for all government and civil purposes. Decimal time became mandatory on September 22, 1794. And almost immediately, the system began to collapse under the weight of human stubbornness.</p>
      ...
      <p>Napoleon abolished the Republican Calendar on January 1, 1806&mdash;11 Nivôse Year XIV, in the system&apos;s own reckoning&mdash;as part of his rapprochement with the Catholic Church through the Concordat of 1801. France returned to the Gregorian calendar, to Sundays and saints, to the ancient rhythm that the Revolution had tried to break. The experiment appeared to be over.</p>
