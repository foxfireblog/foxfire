...
export default function TheRetractionProblem() {
  return (
    ...
    >
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://howtopublishscience.org/retract.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">How to Publish Science — Retraction Statistics</a></li>
      ...
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://cypher.ulb.be/the-state-of-scientific-publishing-and-integrity-lonni-besancon-speaks-at-cypher-3rd-general-meeting-in-istanbul/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Zombie Citations in Systematic Reviews — ULB Study</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://journalistsresource.org/home/retraction-research-fake-peer-review/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">AI Hallucinated Citations — Journalist&apos;s Resource</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://journalistsresource.org/home/retraction-research-fake-peer-review/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">News Coverage of Retracted Studies — 2025 Analysis</a></li>
      ...
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><a href="https://langcog.stanford.edu/papers_new/osc-2015-science.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Open Science Collaboration Reproducibility Project — Stanford</a></li>
      </ol>
