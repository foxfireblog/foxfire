...
export default function TheGrammarOfSymmetry() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="14 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-grammar-of-symmetry.opus"
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://doi.org/10.1073/pnas.2001045117" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Evans, S.D., Hughes, I.V., Gehling, J.G., &amp; Droser, M.L. (2020). &ldquo;Discovery of the oldest bilaterian from the Ediacaran of South Australia.&rdquo; PNAS.</a></li>
