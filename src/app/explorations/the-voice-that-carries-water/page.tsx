...
export default function TheVoiceThatCarriesWater() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Dr. Samuel Rosen and the Mabaan hearing studies (ASHA)</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Presbycusis vs. sociocusis: noise-induced hearing loss research</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Gordon Hempton on silence extinction and acoustic horizons (DailyGood)</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Bernie Krause on soundscape ecology and biophony (Mongabay)</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Lynne Kelly, <em>The Memory Code</em>, and Aboriginal songlines (Rounded Globe)</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Daniel Kish and human echolocation (TED)</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Ben Underwood and Erik Weihenmayer: echolocation in practice (Johns Hopkins Newsletter)</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Acoustic dispersion in ice and Nordic ice-reading traditions (Cambridge University Press)</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Distributed Acoustic Sensing for ice thickness measurement (MDPI, 2024)</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Nico Declercq on the acoustics of Epidaurus (Greece High Definition)</li>
      </ol>
