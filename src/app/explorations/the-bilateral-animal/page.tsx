...
export default function TheBilateralAnimal() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Catherine O&apos;Hara&apos;s situs inversus diagnosis &mdash; Myacare</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Situs inversus: frequency and clinical implications &mdash; Cleveland Clinic</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Bilateria: the bilateral animal clade &mdash; Grokipedia</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://en.wikipedia.org/wiki/Kimberella" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Kimberella and early bilaterian fossils &mdash; Wikipedia</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Bilateral symmetry in sessile organisms and internal fluid transport &mdash; Frontiers in Ecology and Evolution</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>The Nodal signaling cascade and left-right organizer &mdash; The Company of Biologists</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Primary Ciliary Dyskinesia and Kartagener Syndrome &mdash; Everyday Health</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Reptile symmetry-breaking without motile cilia &mdash; The Company of Biologists</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Amphistium paradoxum and flatfish eye migration &mdash; Nix Illustration</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Fluctuating asymmetry and facial attractiveness: methodological critiques &mdash; ResearchGate</li>
      </ol>
