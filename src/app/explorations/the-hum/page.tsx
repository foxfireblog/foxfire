    ...
    ><article>
      ...
      <p>I think that might be the most any of us can offer each other, standing in our separate perceptions, hearing our separate sounds. Not a solution. Not certainty. Just the willingness to say: I believe you. I don&apos;t understand it. But I believe that you hear it. And in the silence between us, where the Hum either is or isn&apos;t, something resonates.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://thehum.info/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The World Hum Map and Database Project (Dr. Glen MacPherson)</a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://www.coastreporter.net/local-news/gibsons-teacher-tracking-worldwide-hum-3351336" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">2. &quot;Gibsons teacher tracking Worldwide Hum&quot; (Coast Reporter)</a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://www.scientificexploration.org/docs/18/jse_18_4_deming.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;The Hum: An Anomalous Sound Heard Around the World&quot; (Journal of Scientific Exploration)</a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://web.archive.org/web/20140816045501/http://www.acousticalsociety.org/sites/default/files/docs/echoes/v5n3.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;The Mystery of the Taos Hum&quot; (Echoes: The Newsletter of the Acoustical Society of America)</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.uwindsor.ca/engineering/novak/301/windsor-hum-study" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;Investigation of the Windsor Hum&quot; (University of Windsor / Canadian Department of Foreign Affairs)</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.mic.com/articles/91091/a-mysterious-sound-is-driving-people-insane-and-nobody-knows-what-s-causing-it" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;A Mysterious Sound is Driving People Insane — And Nobody Knows What's Causing It&quot; (Mic)</a></li>
            <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span> <a href="https://www.theguardian.com/cities/2021/jul/07/can-you-hear-the-hum-the-mystery-noise-that-says-a-lot-about-modern-life" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;Can you hear the Hum? The mystery noise that says a lot about modern life&quot; (The Guardian)</a></li>
            <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span> <a href="https://www.livescience.com/38427-the-hum-mystery-taos-windsor.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">&quot;Mysterious Hum Driving People Crazy Around the World&quot; (Live Science)</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
