...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Half-Life%20of%20a%20Fact&category=Essay&color=amber&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheHalfLifeOfAFact() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Charles Sidney Burwell and the Harvard Medical School Commencement Warning</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Derek_J._de_Solla_Price" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Derek J. de Solla Price — Wikipedia</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>The Marginalian — The Half-Life of Facts</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Poynard et al. — Annals of Internal Medicine (2002)</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Samuel Arbesman — The Half-Life of Facts (2012)</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>The Human Chromosome Count — History and Controversy</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://en.wikipedia.org/wiki/Joe_Hin_Tjio" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Joe Hin Tjio — Wikipedia</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>The Bone Wars and the Brontosaurus — Dinosaur Park</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Tschopp, Mateus, &amp; Benson — A Specimen-Level Phylogenetic Analysis (PeerJ, 2015)</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Arbesman on Mesofacts — CFA Institute</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>Rekdal &amp; Sutton — The Spinach Iron Myth Debunked</li>
      </ol>
