...
export default function TheManWhoMeasuredSuffering() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="13 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-man-who-measured-suffering.opus"
    >
      ...
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://pubmed.ncbi.nlm.nih.gov/36857342/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">NIH — Kahneman &amp; Killingsworth (2023) on Income and Happiness</a></li>
