...
export default function TheVanillaConspiracy() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Yucatan Living &mdash; The Totonac Legend of Princess Xanat</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Ingredi.com &mdash; Chemical Complexity of Natural vs. Synthetic Vanilla</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Apiservices &mdash; The Pollinator Debate: Melipona vs. Eulaema Bees</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Aztec Vanilla &mdash; Totonac and Aztec History of Vanilla Cultivation</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>The Linnean Society &mdash; European Attempts to Cultivate Vanilla</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://en.wikipedia.org/wiki/Edmond_Albius" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia &mdash; Edmond Albius</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Greater Africa Foundation &mdash; Réunion&apos;s Vanilla Export History</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>BlackPast &mdash; Edmond Albius and the Richard Controversy</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>National Geographic &mdash; The Tragedy of Edmond Albius</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://www.etymonline.com/word/vanilla" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Etymonline &mdash; Origin of the Word &ldquo;Vanilla&rdquo;</a></li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>US Department of Labor &mdash; Child Labor in Madagascar&apos;s Vanilla Sector</li>
      </ol>
