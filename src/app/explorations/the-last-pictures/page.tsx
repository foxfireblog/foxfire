...
export default function TheLastPictures() {
  return (
    ...
    >
      ...
      <p>Paglen found this dishonest. Or at least incomplete. He built his project around a quote from the historian Arnold Toynbee: &ldquo;Civilizations die from suicide, not by murder.&rdquo; Where Sagan asked &ldquo;What is the best of us?&rdquo; Paglen asked &ldquo;What have we done?&rdquo;&mdash;and the answers included drones and diseases and environmental collapse and industrial slaughter. It is not a nihilistic collection. There is beauty in it, there is wonder, there are those orphan children seeing the ocean. But it refuses the lie of omission. It insists on showing the wound alongside the smile.</p>
      ...
      <p>Herzog loved <em>The Last Pictures</em>. He called it &ldquo;a conquest of the useless&rdquo;&mdash;his highest compliment, borrowed from his own philosophy of meaningful futility&mdash;and &ldquo;one of the most amazing, beautiful photo books I&apos;ve ever seen.&rdquo; But he also publicly roasted Paglen for one crucial decision: the absence of captions. Herzog pointed out, with characteristic bluntness, that aliens might not have eyes. They certainly wouldn&apos;t have the cultural context to understand why a smiling girl in a Japanese internment camp is not a happy photograph. &ldquo;How do you tell them about the background of the photo?&rdquo; Herzog demanded.</p>
