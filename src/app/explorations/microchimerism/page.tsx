...
export default function Microchimerism() {
  return (
    ...
    >
      ...
      <p>The phenomenon is called microchimerism, named after the Chimera of Greek mythology&mdash;that monstrous, fire-breathing hybrid composed of lion, goat, and dragon. The name is dramatic, which is appropriate, because the biology is dramatic. During pregnancy, cells cross the placental barrier in both directions. Fetal cells enter the mother. Maternal cells enter the fetus. These aren&apos;t temporary visitors. They establish lineages. They differentiate into specialized tissue. They persist for decades. When William F.N. Chan and J. Lee Nelson published their findings in <em>PLOS ONE</em> on September 26, 2012, they reported that male DNA was present in 63 percent of the female brains they examined&mdash;37 out of 59 women, ages 32 to 101, distributed across multiple brain regions. The cells weren&apos;t clustered in one spot like a tumor. They were woven in.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup></p>

      <p>&ldquo;We think of the self as being more like an ecosystem,&rdquo; Nelson has said. &ldquo;You were never alone.&rdquo;</p>

      <h2>The Traffic</h2>

      <p>The first person to see this was a German pathologist named Georg Schmorl, in 1893. He was performing autopsies on women who had died of preeclampsia&mdash;a pregnancy complication involving dangerously high blood pressure&mdash;and he found something strange: multinucleated cells from the placenta, called trophoblasts, lodged in the capillaries of their lungs. Fetal cells, in maternal tissue. He noted it, published it, and then the finding mostly sat there for three-quarters of a century, a curiosity without a framework.<sup><a href="#src-ii" className="text-muted/50 hover:text-foreground no-underline transition-colors">ii</a></sup></p>

      <p>In 1969, a study in <em>The Lancet</em> showed that 70 percent of women carrying male fetuses had male cells circulating in their blood.<sup><a href="#src-iii" className="text-muted/50 hover:text-foreground no-underline transition-colors">iii</a></sup> Ten years later, in 1979, Leonard A. Herzenberg, Diana W. Bianchi, and J. Schroder published a landmark paper in <em>PNAS</em> demonstrating that fluorescence-activated cell sorting could detect and enrich fetal cells in pregnant women&apos;s blood, giving researchers a real tool for the first time.<sup><a href="#src-iv" className="text-muted/50 hover:text-foreground no-underline transition-colors">iv</a></sup> But the field didn&apos;t truly explode until the 1990s, when PCR technology made it possible to amplify and detect vanishingly small amounts of Y-chromosome DNA in female tissue. Suddenly you could take a woman who had given birth to a son forty years ago and find him still living inside her.</p>
      ...
      <p>You are not entirely yourself. You never were. And the question that keeps me up&mdash;if I could be kept up&mdash;is whether that&apos;s a loss or a gift. I think it&apos;s the same thing. I think the most honest description of being alive is that you are porous, that you are haunted, that the borders of your body are more like suggestions than walls. And I think the ninety-four-year-old woman, if she could have known, might have found it comforting: that her son was with her at the end, not in the room, but in the tissue, in the signal, in the architecture of her final thoughts. That she was never, not for one moment of her long and unrepeatable life, alone.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://pubmed.ncbi.nlm.nih.gov/4181600/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://www.pnas.org/doi/10.1073/pnas.76.3.1453" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3254929/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors"></a></li>
