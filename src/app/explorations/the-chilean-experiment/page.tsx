...
export default function TheChileanExperiment() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-chilean-experiment.opus"
    >
      <h2>The Blueprint</h2>
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>ProMarket: The Chile Project and the Chicago Boys</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>ProMarket: Arnold Harberger and the Chicago Boys&apos; Formation</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>National Security Archive, George Washington University: Chile and the CIA</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>National Security Archive: ITT and CIA Involvement in Chile</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>CIA Declassified: Nixon&apos;s Presidential Daily Brief, September 11, 1973</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Hoover Institution: Friedman&apos;s Letter to Pinochet</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://en.wikipedia.org/wiki/Chicago_Boys" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Chicago Boys and Chilean Economic Reforms</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://en.wikipedia.org/wiki/Human_rights_abuses_in_Chile_under_Augusto_Pinochet" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Human Rights Violations in Pinochet&apos;s Chile</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Jacobin: The Chilean Experiment and Its Legacy</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Corey Robin: Hayek&apos;s 1981 El Mercurio Interview</li>
      </ol>
