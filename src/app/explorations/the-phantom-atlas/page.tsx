...
export default function ThePhantomAtlas() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://www.belfastentries.com/stories/myths-legends/hy-brasil/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Hy-Brasil: The Phantom Island of Irish Myth (Belfast Entries)</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://www.historicmysteries.com/myths-legends/hy-brasil-the-other-atlantis/1055/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The Mountains of Kong: A Cartographic Myth (Historic Mysteries)</a></li>
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://templars.fandom.com/wiki/Zeno_Map" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Frobisher&apos;s Encounter with the Zeno Map (Fandom)</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://www.geographyrealm.com/the-map-myth-of-sandy-island/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Phantom Islands and Cartographic Inertia (Geography Realm)</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://www.boreal.org/2018/01/20/165002/ancient-maps-show-islands-that-dont-really-exist" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Crocker Land and the Arctic Mirage (Boreal)</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://www.atlasobscura.com/articles/zeno-map-phantom-island-cartography" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The Murder of Piugaattoq (Atlas Obscura)</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://www.nationalgeographic.com/culture/article/maps-undiscovered-fake-islands-cartography" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Sandy Island: The Un-Discovery (National Geographic)</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://mexiconewsdaily.com/politics/vanished-isle-in-gulf-of-mexico/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Isla Bermeja: Mexico&apos;s Missing Island (Mexico News Daily)</a></li>
      </ol>
