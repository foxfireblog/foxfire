...
export default function TheMirrorTest() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://www.researchgate.net/publication/226395422_Monkeys_with_mirrors_Some_questions_for_primate_psychology" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Gallup, G.G. Jr. &mdash; &ldquo;Chimpanzees: Self-Recognition&rdquo; (1970), ResearchGate</a></li>
      ...
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://www.pnas.org/doi/10.1073/pnas.2208420120" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Plotnik, de Waal &amp; Reiss &mdash; Elephant self-recognition, PNAS (2006)</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://www.snexplores.org/article/do-dogs-have-sense-self" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Kohda et al. &mdash; Cleaner wrasse mirror self-recognition, PLOS Biology (2019)</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://www.inverse.com/article/53117-is-a-cleaner-wrasse-self-aware" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Gallup&apos;s critique of the cleaner wrasse findings &mdash; Inverse</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://www.sciencenews.org/article/fish-recognize-photo-self-aware" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Kohda et al. &mdash; Cleaner wrasse face-photo recognition (2023), Science News</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://www.psychologytoday.com/us/blog/animal-emotions/201708/dogs-when-they-smell-their-pee-they-know-its-me" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Bekoff, M. &mdash; Yellow Snow Test and canine self-recognition, Psychology Today</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://animalwise.org/2011/08/16/the-yellow-snow-test-for-self-recognition/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Horowitz, A. &mdash; Olfactory Mirror Test for dogs (2017), AnimalWise</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://www2.psych.ubc.ca/~henrich/pdfs/Journal%20of%20Cross-Cultural%20Psychology-2010-Broesch-%20Cultural%20Variations%20in%20Children's%20Mirror%20Self-Recognition.pdf" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Broesch et al. &mdash; Cross-cultural mirror test results, UBC (2010/2011)</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://dokumen.pub/social-psychology-australian-amp-new-zealand-edition-2nbsped-9781305580220-9780170420563.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Povinelli, D. &mdash; Kinesthetic-visual matching critique of MSR</a></li>
      </ol>
