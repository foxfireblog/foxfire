...
export default function TheMathematicsOfTheHeartbeat() {
  return (
    ...
    >
      ...
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Goldberger et al., &ldquo;Fractal dynamics in physiology&rdquo; &mdash; loss of complexity in disease and aging</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Kobayashi &amp; Musha (1982), &ldquo;1/f Fluctuation of Heartbeat Period&rdquo;</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Peng et al. (1995), Detrended Fluctuation Analysis of long-range correlations in heartbeat intervals</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Goldberger (1985), the &ldquo;Fractal Hypothesis&rdquo; &mdash; His-Purkinje network as fractal architecture</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Glass &amp; Mackey (1977), &ldquo;Oscillation and Chaos in Physiological Control Systems&rdquo; &mdash; coining &ldquo;dynamical disease&rdquo;</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>VF as low-dimensional pathological oscillation with rotor-driven periodicity</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Systemic loss of complexity in aging &mdash; gait, neural, and hematopoietic fractal decline</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Wearables, AI, and early warning signals &mdash; modern applications of HRV complexity analysis</li>
      </ol>
