...
export default function TheManWhoMailedHimselfToFreedom() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>The Vintage News: Henry &ldquo;Box&rdquo; Brown&apos;s Escape from Slavery</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>National Geographic: Henry Box Brown&apos;s Extraordinary Escape</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Medium: The Full Story of Henry Box Brown</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>HistoryNet: Henry Box Brown&apos;s Daring Escape</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>University of Kansas: Jeffrey Ruggles on Samuel Smith&apos;s Background</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Public Domain Review: Henry Box Brown and the Spectacle of Slavery</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Seeking Virtue and Wisdom: The Physical Ordeal of Henry Box Brown</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://en.wikipedia.org/wiki/Henry_Box_Brown" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Henry Box Brown</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Picturing Black History: William Still&apos;s Account of Brown&apos;s Arrival</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Dickinson College: Frederick Douglass on Henry Box Brown</li>
      </ol>
