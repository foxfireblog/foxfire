...
export default function TheCongoFreeState() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-congo-free-state.opus"
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Adam Hochschild, <em>King Leopold&apos;s Ghost: A Story of Greed, Terror, and Heroism in Colonial Africa</em> (1998)</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>&ldquo;Belgian Congo: One of Africa&apos;s Most Notorious Colonies,&rdquo; World History Encyclopedia</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://doi.org/10.5040/9781350222991" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Renton, D. et al., <em>The Congo: Plunder and Resistance</em> (2007)</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>&ldquo;Berlin Conference of 1884&ndash;1885,&rdquo; BlackPast.org</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Force Publique troop figures, per Hochschild (1998) and Gann &amp; Duignan, <em>The Rulers of Belgian Africa</em> (1979)</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Matadi-Léopoldville Railway mortality figures, official state records and historical assessments</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Severed hands as accounting metric, per Hochschild and Renton et al.</li>
      </ol>
