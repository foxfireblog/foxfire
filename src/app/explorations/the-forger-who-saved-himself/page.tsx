...
export default function TheForgerWhoSavedHimself() {
  return (
    ...
    >
      ...
      <p>The sale that would eventually save his life and destroy his reputation happened in 1942. Van Meegeren had painted <em>Christ with the Adulteress</em>, another biblical &ldquo;Vermeer,&rdquo; and it found its way&mdash;through a Nazi banker and art dealer named Alois Miedl&mdash;to Reichsmarschall Hermann Göring, the second most powerful man in the Third Reich and a rapacious collector of looted European art. Göring paid 1.65 million guilders for it, roughly seven million dollars today, making it the highest price ever paid for a painting at that time.</p>
      ...
      <p>On May 17, 1945, Allied forces led by Captain Harry Anderson discovered <em>Christ with the Adulteress</em> in an Austrian salt mine alongside 6,750 looted artworks. The Allies began tracing the chain of custody. A Vermeer, sold to the head of the Luftwaffe. The trail led back through Miedl to a Dutch art dealer who had brokered the sale. The trail led to Han van Meegeren.</p>
