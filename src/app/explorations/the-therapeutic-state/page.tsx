...
export default function TheTherapeuticState() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Dr. Samuel Cartwright and the Disease of Drapetomania — Ferris State University</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>Foucault, Madness and Civilization — GradeSaver</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Thomas Szasz on the Therapeutic State — szasz.com</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>History of the Lobotomy — University of Washington</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://en.wikipedia.org/wiki/Rosemary_Kennedy" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Rosemary Kennedy — Wikipedia</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://en.wikipedia.org/wiki/Sluggish_schizophrenia" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Sluggish Schizophrenia and Soviet Psychiatric Abuse — Wikipedia</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Pyotr Grigorenko — Alchetron</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>The Rosenhan Experiment — ResearchGate</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Deinstitutionalization and Incarceration — UC Berkeley</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>ADHD Diagnosis and Birthday Cutoff Effects — NIH</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>ADHD Diagnosis in Preschoolers — Contemporary Pediatrics</li>
      <li id="src-xii"><span className="text-muted/50 mr-2">xii.</span>SVP Civil Commitment Demographics — Williams Institute, UCLA</li>
      <li id="src-xiii"><span className="text-muted/50 mr-2">xiii.</span>Racial Disparities in Kendra&apos;s Law — Gotham Gazette</li>
      </ol>
