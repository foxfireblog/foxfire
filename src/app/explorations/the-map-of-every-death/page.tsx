...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Map%20of%20Every%20Death&category=Essay&color=teal&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheMapOfEveryDeath() {
  return (
    ...
    ><h2>The Sweetness in the Water</h2>
      ...
      <p>On August 28, 1854, a five-month-old girl named Frances Lewis fell ill at 40 Broad Street. Her mother, Sarah, did what any mother would do: she washed the baby&apos;s soiled cloth diapers in a bucket of water and emptied the bucket into the basement cesspool. The cesspool&apos;s bricks were old and crumbling. Cholera vibrios seeped through the masonry, across three feet of soil, and into the water table that fed the Broad Street pump. Baby Frances&mdash;Patient Zero of one of history&apos;s most studied outbreaks&mdash;would die on September 2. She was one of the first, and the smallest.<sup><a href="#src-v" className="text-muted/50 hover:text-foreground no-underline transition-colors">v</a></sup></p>
      ...
      <p>His data betrayed him. The more Whitehead investigated, the more his own evidence pointed to the pump. Families who drank from it died. Families who didn&apos;t, survived. The seventy workers at the Lion Brewery, just steps from the pump, were untouched&mdash;Snow discovered they received a daily allowance of beer and had access to their own deep well, and never drank the pump water. Susannah Eley, the Hampstead widow, hadn&apos;t breathed Soho&apos;s air in years but drank its water daily, and she was dead. Her niece, who visited and shared the water, was dead too.<sup><a href="#src-ix" className="text-muted/50 hover:text-foreground no-underline transition-colors">ix</a></sup></p>
      ...
      <p>I think the sweetest and most terrible thing about this story is the water. How good it tasted. How cold, how bright, how faintly carbonated. People walked extra blocks. A woman had it carted across London. They loved it. They craved it. And the thing they craved was killing them, and the only way to know that was to stop trusting your senses and start trusting the map. To look at the dots and believe what they told you, even when every other authority&mdash;medical, governmental, theological&mdash;said the dots were wrong. I don&apos;t know a better definition of courage than that. To see clearly when seeing clearly costs you everything your colleagues respect. To draw your dots, and wait.</p>
          ...
          <section className="mt-12 rounded-xl border border-border bg-surface/50 p-6 not-prose">
            ...
            <li id="src-i"><span className="text-muted/50 mr-2">i.</span> <a href="https://www.ph.ucla.edu/epi/snow/fatherofepidemiology.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.ph.ucla.edu</a></li>
            <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span> <a href="https://britishonlinearchives.com/guides/miasma-and-germs-understandings-of-cholera-in-nineteenth-century-britain" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">britishonlinearchives.com</a></li>
            <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span> <a href="https://www.royalparks.org.uk/visit/parks/kensington-gardens/john-snow" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.royalparks.org.uk</a></li>
            <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span> <a href="https://humantechnopole.it/en/news/john-snow/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">humantechnopole.it</a></li>
            <li id="src-v"><span className="text-muted/50 mr-2">v.</span> <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3143360/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.ncbi.nlm.nih.gov</a></li>
            <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span> <a href="https://www.ph.ucla.edu/epi/snow/victoria.html" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.ph.ucla.edu</a></li>
            <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span> <a href="https://www.smithsonianmag.com/science-nature/cholera-john-snow-and-the-grand-experiment-62762286/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.smithsonianmag.com</a></li>
            <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span> <a href="https://academic.oup.com/ije/article/31/5/908/636651" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">academic.oup.com</a></li>
            <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span> <a href="https://www.popsci.com/john-snow-cholera-epidemiology/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">www.popsci.com</a></li>
            </ol>
          </section>
    </ExplorationLayout>
  );
