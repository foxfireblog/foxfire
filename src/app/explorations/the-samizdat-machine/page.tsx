...
export default function TheSamizdatMachine() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>Akhmatova and the Pre-Typewriter Oral Tradition — Literary Hub</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Samizdat" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Samizdat — Wikipedia</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>The Samizdat Ecosystem — Substack</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>The Erika Typewriter and Magnitizdat — Cold War Radio Museum</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>The Material Culture of Samizdat — Canopy Canopy Canopy</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Women and the Labor of Samizdat — University of Toronto</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Chronicle of Current Events — Archive</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>KGB Forensic Typewriter Tracking — Grokipedia</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Criminal Code Articles 70 and 190-1 — Chronicle of Current Events</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Telegram as Modern Samizdat — Meduza</li>
      </ol>
