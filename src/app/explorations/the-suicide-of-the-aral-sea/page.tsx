...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Suicide%20of%20the%20Aral%20Sea&category=Elegy&color=amber&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheSuicideOfTheAralSea() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span>ArcGIS: The Aral Sea Crisis</li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span>World Bank: Aral Sea Overview and Kok-Aral Dam</li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Monthly Review: The Political Economy of the Aral Sea Disaster</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>CUNY: History of the Aral Sea and Soviet Cotton Policy</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Texas A&amp;M University: The Karakum Canal and Water Loss</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span>Tidsskriftet: Health Consequences of the Aral Sea Crisis</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Adarsh Badri: Voices from the Aral Sea</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Arms Control Association: Vozrozhdeniya Island Bioweapons History</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Popular Mechanics: The Anthrax Island</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>EOS: Satellite Data on Aral Sea Dust Storms</li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span>UNDP: Green Aral Sea Initiative and Saxaul Planting</li>
      </ol>
