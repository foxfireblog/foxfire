...
export default function TheMolePeople() {
  return (
    <ExplorationLayout
      ...
      nextReadTime="12 min"
      audioSrc="https://pub-6bb1aea8e67e4e35942a85668408c2e9.r2.dev/audio/the-mole-people.opus"
    >
      ...
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span>Chris &ldquo;Freedom&rdquo; Pape and the Freedom Tunnel murals</li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span>Bernard Isaacs and life in the Freedom Tunnel</li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>Marc Singer and the making of <em>Dark Days</em> (2000)</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><em>Dark Days</em> production details: scavenged equipment, resident crew members</li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Matthew O&apos;Brien, <em>Beneath the Neon</em> (2007) and Las Vegas tunnel communities</li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span>Bucharest tunnel children, Bruce Lee, and Joost Vandebrug&apos;s documentation</li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>Les UX, the catacomb cinema, and Untergunther&apos;s Panthéon clock repair</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span>Section 8 vouchers for tunnel residents; Housing First outcomes via Coalition for the Homeless</li>
      </ol>
