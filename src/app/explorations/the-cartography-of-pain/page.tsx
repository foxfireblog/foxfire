...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Cartography%20of%20Pain&category=Essay&color=rose&readTime=15%20min&v=2",
        width: 1200,
        height: 630,
