...
export default function TheFruitThatsDyingTwice() {
  return (
    ...
    >
      ...
      <p>Australian farmers are terrified to grow it. Not because they doubt the science&mdash;they can see TR4 marching toward their fields as clearly as anyone&mdash;but because they fear consumer backlash against a genetically modified fruit. The label &ldquo;GMO&rdquo; carries a stigma that decades of scientific consensus have failed to dissolve. Growers view the QCAV-4 not as a frontline defense but as a &ldquo;doomsday vault&rdquo; option, a last resort to be deployed only if TR4 fully annihilates conventional crops. Only after catastrophe. Only after the market has no choice.</p>
