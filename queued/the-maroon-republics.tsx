...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Maroon%20Republics&category=Essay&color=emerald&readTime=13%20min",
        width: 1200,
        height: 630,
