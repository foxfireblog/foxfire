...
export default function TheArsenicEatersOfStyria() {
  return (
    ...
    >
      ...
      <p>Sometime in the mid-nineteenth century, in a valley in the Austrian Alps, a sixty-year-old man sits down to breakfast. He takes a piece of bread, spreads it with bacon fat, and carefully sprinkles onto it a white powder&mdash;about 250 milligrams of arsenic trioxide. Enough to kill two healthy adults. He eats it the way you might eat toast with jam. He has been doing this for decades. He is, by all accounts, in excellent health.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup></p>
      ...
      <p>Which returns the whole question to Ligist, and to the twenty-six-year-old house servant who told Dr. Maclagan what happened when he went two weeks without his dose. Not pain, exactly. Not illness. <em>Longing.</em> As if the poison had become something he loved, or something his body loved on his behalf, below the threshold of choice. He could not have told you which of the thousand things he swallowed each day were keeping him alive, which were killing him slowly, and which were, impossibly, doing both. Neither could his doctors. Neither, entirely, can anyone since. So he ate. He climbed. He breathed the thin mountain air and trusted that the fire in his belly was the kind that warms rather than the kind that burns, and every week of his adult life he sprinkled the white powder onto the bread and placed that bet again before the sun had cleared the ridge.</p>
