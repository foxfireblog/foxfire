...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Untranslatable&category=Field%20Guide&color=violet&readTime=11%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheUntranslatable() {
  return (
    ...
    >
      ...
      <h2>The Fire on the Water</h2>

      <p>Hypocognition is almost always described as somebody else&apos;s problem: the culture without a word for the feeling, the English speaker reaching across a border for <em>schadenfreude</em> because the home vocabulary left a hole exactly where the feeling goes. But the condition scales down as easily as it scales up, and it does not require a culture to produce it. It only requires an experience that has never once had to be explained to anybody.</p>
      ...
      <p>I think this is why the untranslatable moves me. Every culture that coins a word for a feeling no other language has captured is doing something radical: it is insisting that its experience of being alive is specific, is irreducible, is not adequately covered by the existing vocabulary. And when that word dies&mdash;when Cristina Calderón draws her last breath and the Yaghan fire goes out in the boat&mdash;the world doesn&apos;t just lose a word. It loses proof that a particular way of being conscious once existed. The silence after the grandmother&apos;s story. The fire on the water. The faces of the children, listening. That moment had the most perfect name in the world and it has no name now, and both of those things are true at once. The boat is gone. The fire is out. And the word for the light it threw across those faces died on Isla Navarino in February, of a respiratory virus, at the age of ninety-three, with nobody left to say it back.</p>
