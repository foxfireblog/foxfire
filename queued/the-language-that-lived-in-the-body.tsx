...
export default function TheLanguageThatLivedInTheBody() {
  return (
    ...
    >
      ...
      <h2>Where the Language Went</h2>

      <p>Martha&apos;s Vineyard Sign Language is the closest thing there is to a parable about the relationship between a body and the world it inhabits. The deaf islanders didn&apos;t have a disability. They had a body. Their body worked differently from most bodies. And the world around them&mdash;crucially, contingently, beautifully&mdash;decided to meet that difference not with correction but with adaptation. Not with pity but with fluency.</p>

      <p>The gap, on the Vineyard, was never intrinsic. It was constructed, and it could be unconstructed&mdash;not through technology, not through cure, not through making the different body perform normalcy, but through the almost embarrassingly simple act of everyone else learning to communicate in a new way. That is an uncomfortable thing to sit with, because it locates the disability in the architecture. A system&apos;s assumptions about what &ldquo;normal&rdquo; looks like determine whether a person is a participant or an aberration, and those assumptions are a choice a community makes and can unmake. Chilmark made it. Nobody there seems to have thought of it as a moral achievement, or thought about it much at all. They just needed to talk to their neighbors, and some of their neighbors were deaf, so they learned how.</p>
