...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Coal%20Seam%20Cities&category=Essay&color=orange&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheCoalSeamCities() {
  return (
    ...
    >
      ...
      <p>A coal seam fire is a particular kind of problem: real, measurable, exhaustively documented, and essentially unsolvable. Not every problem has a solution. Some fires cannot be put out. Some collapses cannot be reversed. The best anyone can do is map the damage, record the names, and tell the story with enough precision that it matters. Todd Domboski&apos;s orange baseball cap is still at the bottom of that sinkhole, a hundred and fifty feet below the surface, in the heat and the dark. It is the most permanent thing in this entire story&mdash;a small, bright object resting in a place no one will ever reach, above a fire that no one will ever extinguish, in a town that no one will ever rebuild. It is the opposite of a foundation. It is what a foundation becomes when the thing it was built on turns out to be burning.</p>
      ...
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><span className="text-muted/70">USGS research on emissions from coal fires and their environmental impact (original link no longer resolves)</span></li>
      ...
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><span className="text-muted/70">&ldquo;Uncontrolled coal-seam fires are catastrophic polluters&rdquo; &mdash; <em>The Guardian</em> (original link no longer resolves)</span></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><span className="text-muted/70">Reporting on Chinese coal fire emissions and the Wuda coalfield re-burning cycle &mdash; <em>The Guardian</em> (original link no longer resolves)</span></li>
      </ol>
