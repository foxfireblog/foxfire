...
export default function ThePellagraDetectives() {
  return (
    ...
    >
      ...
      <p>The cure was a glass of milk. A handful of beans. A few eggs. No vaccine, no surgery, nothing synthesized in a laboratory, nothing that had to be discovered before it could be administered, because it was already sitting on the other side of the same dining hall. The disease was pellagra, and between 1900 and 1940, it afflicted over three million Americans and killed more than 100,000 of them.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup> It marched through the American South like a biblical plague&mdash;first the rash, symmetrical and angry, blooming across the face and hands like a terrible butterfly. Then the diarrhea. Then the dementia. Then death. Doctors called it the Four Ds. But what they should have called it was the Four Ps: poverty, politics, pride, and the price of cotton.</p>
      ...
      <p>What Goldberger&apos;s case crystallizes, more cleanly than almost any episode in the archives of public health, is the recurring shape of a certain kind of failure. The answer is right there. It is obvious, it is cheap, it is already sitting in the mess hall on the staff&apos;s side of the room. And it goes unheard for two decades because hearing it would require the people with the power to act to accept that they are the mechanism. Not the climate, not the germ, not the constitutional weakness of the Southern poor. The wage structure. The crop lien. The company store. A diagnosis that indicts the diagnostician&apos;s own arrangements will be resisted with a ferocity that no purely scientific objection ever generates, and the resistance will dress itself in the language of scientific caution the entire time.</p>
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><span className="text-muted/60">On the scale of the American pellagra epidemic, US Centers for Disease Control and Prevention (no permanent link available)</span></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Joseph_Goldberger" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Joseph Goldberger&apos;s Public Health Service investigation of pellagra (Wikipedia)</a></li>
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><span className="text-muted/60">Alan M. Kraut, <em>Goldberger&apos;s War: The Life and Work of a Public Health Crusader</em> (Hill and Wang, 2003)</span></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><span className="text-muted/60">The Rankin Prison Farm experiment of 1915, Mississippi Encyclopedia (no permanent link available)</span></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><span className="text-muted/60">On the 1916 &ldquo;filth parties&rdquo; and Goldberger&apos;s self-inoculation experiments, Science History Institute (no permanent link available)</span></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><span className="text-muted/60">On antisemitism in the reception of Goldberger&apos;s findings, Hektoen International (no permanent link available)</span></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><span className="text-muted/60">On pellagra in the American South, <em>American Heritage</em> (no permanent link available)</span></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://en.wikipedia.org/wiki/Nixtamalization" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Nixtamalization and the bioavailability of niacin in maize (Wikipedia)</a></li>
      </ol>
