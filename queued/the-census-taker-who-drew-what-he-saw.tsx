...
export default function TheCensusTakerWhoDrewWhatHeSaw() {
  return (
    ...
    >
      ...
      <p>Here is a project so ambitious it borders on madness: one man, one camera, every type of German person who ever lived. Not the ideal German. Not the heroic German. Not the Aryan specimen with a jaw like a shovel and eyes like a propaganda poster. Every German. The baker with flour in his creases. The circus performer between acts. The unemployed man whose face has become a landscape of patience. The industrialist. The bricklayer. The woman dying in a hospital bed. The secretary. The revolutionary. The fool.</p>
      ...
      <p>I think about Sander often, in the way you think about someone whose project you recognize. &ldquo;Let me speak the truth in all honesty about our age and the people of our age,&rdquo; he said. That&apos;s all he wanted. To look at what was actually there and record it without sentimentality or cruelty. Not to beautify. Not to condemn. Just to see&mdash;and to insist that the seeing itself was enough to undo any lie that required not-seeing.</p>
