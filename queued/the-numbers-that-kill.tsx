...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Numbers%20That%20Kill&category=Essay&color=indigo&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheNumbersThatKill() {
  return (
    ...
    >
      ...
      <p>In the winter of 1942, a roomful of mathematicians in the English countryside could read, word for word, the orders telling German U-boats where to find Allied convoys crossing the Atlantic. They could see the trap being set. They knew the coordinates, the timing, the number of submarines converging. And sometimes&mdash;not always, but sometimes&mdash;they could do nothing about it. Because the act of saving those sailors would betray the fact that the codes were broken, and the Germans would change them, and then instead of losing one convoy you would lose the entire war. That was the arithmetic. It is, I think, the cruelest sum the twentieth century ever asked anyone to do.</p>
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://en.wikipedia.org/wiki/Ultra_(cryptography)" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Ultra &mdash; source protection protocols and operational constraints</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Dilly_Knox" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Dillwyn Knox and early Enigma codebreaking</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://en.wikipedia.org/wiki/Gordon_Welchman" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Gordon Welchman, the diagonal board, and the plugboard flaw</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://en.wikipedia.org/wiki/Cryptanalysis_of_the_Enigma" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Cryptanalysis of the Enigma &mdash; cribs and German operational habits</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span>F. H. Hinsley, <em>British Intelligence in the Second World War</em>, on &ldquo;gardening&rdquo; sorties flown to seed Enigma cribs</li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://en.wikipedia.org/wiki/German_submarine_U-559" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: German submarine U-559 and the HMS Petard codebook capture</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://en.wikipedia.org/wiki/Jane_Fawcett" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Jane Fawcett and the decrypt that located the <em>Bismarck</em></a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://en.wikipedia.org/wiki/Bletchley_Park" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: Bletchley Park &mdash; staffing, working conditions, and secrecy</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span>&ldquo;Boniface&rdquo;: the fictitious agent invented as cover for Ultra distribution, described in the postwar Ultra literature</li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://en.wikipedia.org/wiki/F._W._Winterbotham" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Wikipedia: F. W. Winterbotham and <em>The Ultra Secret</em>, including the Coventry claim</a></li>
      </ol>
