...
export default function TheCenote() {
  return (
    ...
    >
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://en.wikipedia.org/wiki/Sacred_Cenote" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Edward Herbert Thompson and the Sacred Cenote — Wikipedia</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://archaeology.org/issues/january-february-2015/collection/mexico-cave-clovis-dna-naia/top-10-discoveries-of-2014/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Guillermo de Anda&apos;s analysis of Sacred Cenote remains — Archaeology Magazine</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://storymaps.arcgis.com/stories/3f792d2da73b4f8db25f6c04576998ed" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Cenotes and the Yucatán karst aquifer — ArcGIS</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://www.bps.org.uk/psychologist/fixing-problems-under-surface" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Psychological effects of cave diving — British Psychological Society</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://www.sunnyexplores.com/diving-the-cenotes-in-yucatan-mexico-cenote-angelita/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Cenote halocline and hydrogen sulfide layers — Sunny Explores</a></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://historyarchive.org/works/creators/edward-herbert-thompson" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Thompson&apos;s dredging of the Sacred Cenote — History Archive</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://www.researchgate.net/publication/325210568_Xibalba_the_Place_of_Fear_Caves_and_the_Ancient_Maya_Underworld" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Mercury contamination in the Sacred Cenote — ResearchGate</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://www.nationalgeographic.com/environment/article/tren-maya-cenotes-yucatan-mexico" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Hoyo Negro and the discovery of Naia — National Geographic</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://insearchofholywellsandhealingsprings.wordpress.com/category/first-nation/" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Tren Maya environmental destruction of cave systems — WordPress</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://yucatanliving.com/history-mythology/edward-herbert-thompson" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Thompson lawsuit and artifact repatriation — Yucatan Living</a></li>
      </ol>
