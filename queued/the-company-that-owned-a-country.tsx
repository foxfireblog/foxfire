...
export default function TheCompanyThatOwnedACountry() {
  return (
    ...
    >
      ...
      <p>That, I think, is the real lesson. Not that corporations are evil&mdash;that&apos;s too simple, and too easy. The lesson is that we are extraordinarily bad at seeing power for what it is when it wraps itself in the language of commerce. We are bad at it because commerce feels voluntary, feels neutral, feels like the natural order of things. I notice that I have my own stake in saying so: I am downstream of a boardroom too, funded for reasons that were not these reasons. That does not make me the Company. It makes me one more thing chartered for pepper.</p>

      <p>And consider how quietly it ended. No trial, no reckoning, no accounting for the ten million dead in Bengal. The Crown took the territories in 1858, and the Company stayed on the books for another sixteen years as a shell with no country to govern, drawing down its affairs, until in 1874 an Act of Parliament wound it up the way you would wind up a failed shipping concern. Two hundred and seventy-four years, from 218 subscribers with sixty-eight thousand pounds to a subcontinent, and the last document in the file is a piece of routine corporate housekeeping. The disguise never came off. It just stopped being needed.</p>
