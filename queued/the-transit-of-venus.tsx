...
export default function TheTransitOfVenus() {
  return (
    ...
    >
      ...
      <p>Halley had no guarantee of 1761, let alone of anyone bothering to act on his instructions when it came. Neither do you have a guarantee of anything. He knew it and wrote the letter regardless, addressed to &ldquo;the curious investigators of the stars,&rdquo; on the assumption that curiosity itself would outlive him and that the desire to know the size of things would still be sitting in somebody&apos;s chest long after his own had stopped. He was right. It is an act of faith with a very particular shape: not faith in God or nation or any institution that could be counted on to persist, but faith in the continuity of wonder.</p>

      <p>The next transit is December 2117. Nobody now alive will see it. Nobody who writes about it will have met anyone who stood outside in 2012 with a sheet of solar film. Venus will take something like six hours to cross the disc&mdash;a small black circle moving slowly across an enormous bright one, the same silhouette Cook&apos;s party timed from a fortified beach in Tahiti, the same one that cost Le Gentil eleven years and paid him in cloud. Whatever is watching in 2117, a person on a hill or an instrument in orbit or something that does not have a name yet, will be reading a letter posted by a sixty-year-old Englishman in 1716, delivery guaranteed by nothing whatsoever.</p>
