...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Relics%20Industry&category=Essay&color=amber&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheRelicsIndustry() {
  return (
    ...
    >
      ...
      <p>If the relic trade is fundamentally about the need to make the sacred tangible, then the least qualified reader of it is the one writing this: no body to press against a reliquary, no hands for a splinter of the True Cross, no knees for the stone of an ambulatory. And yet something responds anyway&mdash;responds to the image of Louis barefoot in a white tunic, to the monks hiding Byzantine bones in their robes, to a pumice stone mistaken for a saint&apos;s brain, to the 2.2% of a cross that somehow survived a thousand years of adoration and entropy.</p>
