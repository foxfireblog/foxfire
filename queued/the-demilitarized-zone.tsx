...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Demilitarized%20Zone&category=Natural%20History&color=emerald&readTime=14%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheDemilitarizedZone() {
  return (
    ...
    >
      ...
      <h2>The Garden Nobody Planted</h2>

      <p>What the strip demonstrates, more purely than any preserve or park or protected wetland on the planet, is that life does not require permission. The forests inside the DMZ waited for no committee. The bears filed no residency application. The cranes negotiated no flyover rights. Life moved into the space that fear had cleared, filled it with roots and feathers and fur, and assembled something so intricate and interdependent that the scientists who study it are reduced to listening from the fence line with directional microphones, inferring an ecosystem they are not permitted to enter.</p>

      <p>The lesson runs in two directions at once, and both are uncomfortable. It is reassuring, because it means the damage is not always permanent and the world holds reserves of recovery we habitually underestimate. It is humiliating, because the mechanism was not conservation. Nobody protected this. Two armies made a place too dangerous to farm, log, drain, pave, or visit, and two million landmines did the work that a century of environmental law has not managed anywhere else on the peninsula. The most successful wildlife refuge in Korea is an accident of terror, and it holds only as long as the terror does.</p>
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Korean_Demilitarized_Zone" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Korean Demilitarized Zone: documented species counts and habitat types (Wikipedia)</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://en.wikipedia.org/wiki/Korean_Demilitarized_Zone" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Endangered species recorded inside the Korean DMZ (Wikipedia)</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://en.wikipedia.org/wiki/Korean_Demilitarized_Zone" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Korean Demilitarized Zone: ecology, endangered species, and the accidental-refuge effect (Wikipedia)</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://en.wikipedia.org/wiki/Red-crowned_crane" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Red-crowned crane: wintering range, population, and the Cheorwon Basin (Wikipedia)</a></li>
      ...
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><span className="text-muted/60">On de-mining policy and the fate of the DMZ ecosystem, DMZ Forum (no permanent link available)</span></li>
      ...
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><span className="text-muted/60">Kim Seung-ho and the DMZ Ecology Research Institute, profiled in the <em>Los Angeles Times</em>, April 2018 (link expired)</span></li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><span className="text-muted/60">Ted Turner&apos;s 2005 proposal for a DMZ peace park, reported in the <em>Taipei Times</em> (link expired)</span></li>
      </ol>
