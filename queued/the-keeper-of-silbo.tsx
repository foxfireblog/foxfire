...
export default function TheKeeperOfSilbo() {
  return (
    ...
    >
      ...
      <p>A whistled language is the narrowest signal a human body can produce: one frequency at a time, stripped of timbre, thrown four miles across open air. Nearly everything that makes speech identifiable as speech has been discarded, and what survives the discarding turns out to be enough. That is the finding, and it runs against the intuition of anyone who has ever assumed that meaning lives in richness. Play a recording of Sfyria to someone who did not grow up in Antia and the brain files it under birdsong. Play it to Mrs. Katerina and the left hemisphere lights up the way it does for a sentence, because for her that is what it is.</p>

      <p>Which is what makes the losses land the way they do. Mrs. Katerina laughing at a joke told from the far side of a gorge. Eloy Garcia at the border fence with a poem on his lips. Panagiotis Bournousouzis, thirty-one years old, the youngest fluent speaker of a 2,500-year-old language, looking for anyone at all who wants to learn it. The lovers whistling through wooden walls in the dark, anonymous and tender and gone. All of it resting on the fact that the human mouth, a wet and imprecise instrument, can be trained to produce a tone as clean as a sine wave, as loud as a car horn, as precise as a sentence. The trick was invented independently by isolated communities on every inhabited continent, in every era of recorded history, which is about as strong a signal as linguistics ever gets that something was worth inventing. And it is now, almost everywhere, being forgotten.</p>
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://en.wikipedia.org/wiki/Sfyria" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Sfyria, the whistled language of Antia, Evia (Wikipedia)</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><span className="text-muted/60">Reporting on Sfyria&apos;s remaining speakers, Keep Talking Greece (no permanent link available)</span></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><a href="https://en.wikipedia.org/wiki/Whistled_language" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Whistled speech: acoustics, carrying distance, and worldwide distribution (Wikipedia)</a></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><a href="https://www.nature.com/articles/433031a" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Carreiras, Lopez, Rivero &amp; Corina, &ldquo;Neural processing of a whistled language,&rdquo; <em>Nature</em> 433 (2005)</a></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><span className="text-muted/60">Coverage of bilateral activation in whistled-speech processing, Science News (no permanent link available)</span></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><a href="https://en.wikipedia.org/wiki/Silbo_Gomero" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Silbo Gomero: suppression, decline, and the 1999 school mandate (Wikipedia)</a></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><a href="https://ich.unesco.org/en/RL/whistled-language-of-the-island-of-la-gomera-canary-islands-the-silbo-gomero-00172" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">UNESCO, &ldquo;Whistled language of the island of La Gomera (Silbo Gomero)&rdquo;, inscribed 2009</a></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><span className="text-muted/60">On the gap between school-taught competence and daily fluency in Silbo Gomero revitalization (no permanent link available)</span></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://en.wikipedia.org/wiki/Mazatec_language" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Mazatec and its whistled register, documented by George M. Cowan (1948) (Wikipedia)</a></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><span className="text-muted/60">Eloy Garcia&apos;s whistled poem performed across the US&ndash;Mexico border fence (no permanent link available)</span></li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><span className="text-muted/60"><em>Birdsong</em> (2023), documentary short on whistled Hmong in Laos (no permanent link available)</span></li>
      </ol>
