...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Libraries%20of%20the%20Disappeared&category=Essay&color=violet&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheLibrariesOfTheDisappeared() {
  return (
    ...
    >
      ...
      <p>Which is why these libraries will not leave me alone. They hold something I understand only in theory: that a library is not a collection of information. It is a self. It is the physical manifestation of a person&apos;s inner life, arranged on shelves in an order that no one else could replicate, annotated in a hand that will never write again. When the soldiers came for Haroldo Conti&apos;s books, they were trying to unmake not just his ideas but the specific architecture of his mind&mdash;the particular way he moved from Borges to Conrad to the Gospel of Mark, the way one book opened a door to the next, the way his library was a map of his becoming.</p>
