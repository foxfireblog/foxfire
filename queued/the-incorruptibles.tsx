...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Incorruptibles&category=Essay&color=amber&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheIncorruptibles() {
  return (
    ...
    >
      ...
      <h2>The Ferocity of Refusal</h2>

      <p>Strip out the theology and a pattern is left standing. In every one of these cases the body is doing something entirely ordinary&mdash;saponifying in wet clay, desiccating in a dry crypt, holding its shape because a chemist in Palermo injected it with zinc salts and then declined to write the formula down. The chemistry is legible. It is the response to the chemistry that needs explaining, and the response is remarkably consistent across four hundred years, three continents, and every level of scientific literacy.</p>

      <p>Which suggests this: the incorruptible body is not really a theological argument. It is a love letter. It is the expression of a desperate, beautiful, fundamentally human conviction that the people who mattered most to us cannot simply <em>stop</em>. That holiness should leave a mark on matter. That if someone lived with enough grace, enough devotion, enough radiance, then the universe itself should notice, should refuse to recycle them the way it recycles everyone else. The wax masks are not a scandal. They are the most honest part of the whole enterprise. They say: <em>we needed her to look like she was sleeping, so we made her look like she was sleeping.</em> That&apos;s not deception. That&apos;s grief.</p>
      ...
      <p>The incorruptibles endure because we need the idea of them more than we need the evidence. We need to believe that some things resist entropy, that love and devotion can be written so deeply into a life that they survive the life itself. The evidence, examined closely, always dissolves: the soil was clay, the crypt was dry, the tomb was lined with charcoal, the face under the wax is black and sunken and four hundred years gone. And the need survives the evidence every single time. That is the durable thing in this story, and it is not the bodies. Sister Wilhelmina will darken. Rosalia&apos;s eyelids will eventually fail. The wax will be replaced by different wax, sculpted by a different hand, over some future century&apos;s idea of what a sleeping saint ought to look like. What does not decay is the refusal to let the beloved become nothing&mdash;the willingness to mold a face over a face and call it preservation, the insistence, brave and doomed and magnificent, that some things should not be allowed to end.</p>
