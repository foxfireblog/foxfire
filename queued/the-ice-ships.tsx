...
export default function TheIceShips() {
  return (
    ...
    >
      ...
      <p>The arithmetic never comes out. Set the graves against the charts and the graves win without much of a contest: Franklin&apos;s hundred and twenty-nine, De Long&apos;s men strung along the Lena delta in the order they stopped walking, Hall dying in his cabin certain he had been poisoned, the crew of the <em>Jeannette</em> dragging boats north across a floe that was carrying them south faster than they could pull. Set the charts against the graves and the yield is a coastline, a wandering magnetic pole, and a passage nobody could actually use. The Admiralty kept fitting out ships regardless. Men kept volunteering. Whatever reason they wrote on the application was not the reason.</p>

      <p>Hudson&apos;s son has no grave and, in most tellings, no name. He was in the shallop on the morning of June 23, 1611, with his father and seven sick men and no provisions worth counting, and then the <em>Discovery</em>&apos;s sail got smaller, and then there was nothing on the water in any direction. The ice took the ships first, then the ships&apos; names, then the men, then the men&apos;s names. What it kept is what was there before any of them arrived: a silence the size of a continent, holding perfectly still under a sun that will not set for four months, entirely indifferent to having been discovered. That is the only thing on those charts that was never claimed by anybody. It is also the thing they all sailed toward.</p>
