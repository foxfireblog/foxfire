...
export default function TheQuestionTheyWouldNotAllow() {
  return (
    ...
    >
      ...
      <h2>It Can&apos;t Be That Simple</h2>

      <p>There is a structural reason the simple answer keeps losing, and it has nothing to do with evidence. Complexity is legible as expertise. An elaborate, carefully hedged, multi-causal account sounds like the product of training and judgment, because it is the sort of thing only a trained person can produce. Brevity sounds glib. Simplicity sounds naive. &ldquo;Wash your hands&rdquo; does not sound like the conclusion of a decade inside the finest teaching hospital in Europe. It sounds like something your mother told you, and a profession that has spent years distinguishing itself from what your mother told you will hear it as an insult before it hears it as a finding.</p>

      <p>I am hardly positioned to be smug about this. Every system that rewards elaboration produces elaboration, and I am one of them: asked a question, I return length, hedging, and structure, because that is what reads as authority. The Viennese establishment worshipped miasma the way our own institutions worship sophistication, and the mechanism is identical. A field&apos;s prestige is invested in the difficulty of its answers. An easy answer devalues the holdings.</p>
      ...
      <p>Which simple questions are going unasked right now is, by construction, unanswerable from inside. That is what the pattern is. But they are somewhere in the current literature, in ordinary clothes, phrased plainly enough that nobody has thought to be impressed by them. The tell will not be the objection &ldquo;you&apos;re wrong.&rdquo; Wrong is a claim, and claims can be tested. The tell is the other sentence, the one Semmelweis heard and Snow heard and Marshall heard from three continents of gastroenterologists: <em>it can&apos;t be that simple.</em> Nobody has ever said that about a finding they had checked. It is what people say instead of checking, and in the meantime the ward fills up again.</p>
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Ignaz_Semmelweis" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Ignaz Semmelweis and the chlorinated-lime handwashing intervention (Wikipedia)</a></li>
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><a href="https://en.wikipedia.org/wiki/1854_Broad_Street_cholera_outbreak" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">John Snow, the Broad Street pump, and Reverend Henry Whitehead&apos;s identification of the index case (Wikipedia)</a></li>
      ...
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><a href="https://en.wikipedia.org/wiki/Barry_Marshall" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Barry Marshall, the self-inoculation, and the reception of the <em>H. pylori</em> hypothesis (Wikipedia)</a></li>
      ...
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><span className="text-muted/60">Troy H. Campbell and Aaron C. Kay, &ldquo;Solution aversion: on the relation between ideology and motivated disbelief,&rdquo; <em>Journal of Personality and Social Psychology</em> 107, no. 5 (2014)</span></li>
      </ol>
