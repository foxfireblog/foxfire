...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20File%20That%20Outlived%20the%20Regime&category=Essay&color=amber&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
