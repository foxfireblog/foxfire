...
export default function TheWomanWhoCountedTheUncountable() {
  return (
    ...
    >
      ...
      <p>In January 1855, the annualized mortality rate among British soldiers at the barrack hospital at Scutari reached 1,174 per 1,000.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup> The figure is greater than one thousand because it is a rate, not a count, and the arithmetic is doing something the arithmetic was not designed to do: describing a population dying faster than it can be fully replaced over the course of a year. Disease alone. Not Russian bullets, not artillery, not bayonets. Cholera, typhus, dysentery, and the cesspool the hospital had been built on top of. In London, almost nobody knew, because the information existed as rows and columns in reports that no one with the power to act had the patience to read.</p>
      ...
      <h2>The Blue Wedges</h2>

      <p>The diagrams get reproduced now as a milestone in information design, which is accurate and beside the point. Every history of data visualization runs the rose, admires the encoding, notes that she anticipated a century of practice, and moves on to Playfair or Minard. The encoding was not the achievement. Plenty of Victorians could draw. What almost nobody could do was force a government to look at a number it had already decided not to look at, and the rose exists because she worked out that a table would not do it and a picture might.</p>

      <p>So the innovation is not the technical part. It&apos;s the moral architecture. She didn&apos;t count the dead because she loved numbers. She counted the dead because she loved the dead. Each data point in her polar area diagram was a person who had arrived at Scutari with a wound that should have been survivable and instead was handed a death sentence by a bureaucracy that couldn&apos;t be bothered to flush its sewers. The blue wedges of her rose diagram are not abstract. They are, each one of them, a monument to someone who was killed by indifference.</p>
      ...
      <li id="src-i"><span className="text-muted/50 mr-2">i.</span><a href="https://en.wikipedia.org/wiki/Florence_Nightingale" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Florence Nightingale: Crimea, Scutari, and the mortality statistics (Wikipedia)</a></li>
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Selimiye_Barracks" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Selimiye Barracks at Scutari, the building that housed the British hospital (Wikipedia)</a></li>
      <li id="src-iii"><span className="text-muted/50 mr-2">iii.</span><span className="text-muted/60">Nightingale&apos;s Crimean correspondence and returns, held by The National Archives, Kew (no permanent link available)</span></li>
      <li id="src-iv"><span className="text-muted/50 mr-2">iv.</span><span className="text-muted/60">The Sanitary Commission of 1855 and the fall in mortality at Scutari, National Army Museum (no permanent link available)</span></li>
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><span className="text-muted/60">On Nightingale&apos;s critics and the contested reading of the Scutari death rate (no permanent link available)</span></li>
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><span className="text-muted/60">Nightingale&apos;s statistical publications and their reception, Cambridge University Press (no permanent link available)</span></li>
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span><span className="text-muted/60">On Nightingale&apos;s use of graphics in public health argument, National Institutes of Health (no permanent link available)</span></li>
      <li id="src-viii"><span className="text-muted/50 mr-2">viii.</span><a href="https://en.wikipedia.org/wiki/Pie_chart" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Polar area diagrams, and why Nightingale&apos;s rose is not a coxcomb (Wikipedia)</a></li>
      <li id="src-ix"><span className="text-muted/50 mr-2">ix.</span><span className="text-muted/60">Plus Magazine, &ldquo;Florence Nightingale: The passionate statistician&rdquo; (no permanent link available)</span></li>
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://en.wikipedia.org/wiki/Adolphe_Quetelet" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Adolphe Quetelet, social physics, and his influence on Nightingale (Wikipedia)</a></li>
      </ol>
