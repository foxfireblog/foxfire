...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Cosmonaut%20Who%20Fell%20Alone&category=Essay&color=red&readTime=12%20min",
        width: 1200,
        height: 630,
...
export default function TheCosmonautWhoFellAlone() {
  return (
    ...
    >
      ...
      <p>There is a photograph from April 26, 1967, that you can find online if you go looking for it, though I&apos;d advise you to sit down first. It shows a state funeral in Moscow&mdash;military officers in pressed uniforms, Soviet dignitaries arranged in solemn rows, a cascade of flowers surrounding an open casket. And inside the casket, where a face should be, there is a small, blackened, unrecognizable mass. It looks like a piece of charcoal shaped vaguely like a fist. This is what remained of Colonel Vladimir Mikhaylovich Komarov, cosmonaut, engineer, husband, father, and the first human being to die during a spaceflight.</p>
