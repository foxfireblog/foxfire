...
export default function TheLastOrdinaryDay() {
  return (
    ...
    >
      ...
      <li id="src-vi"><span className="text-muted/50 mr-2">vi.</span><span className="text-muted/70">Research on flashbulb memory and the recalled &ldquo;day before&rdquo; in trauma psychology (original link no longer resolves)</span></li>
      ...
      <li id="src-x"><span className="text-muted/50 mr-2">x.</span><a href="https://en.wikipedia.org/wiki/Eruption_of_Mount_Vesuvius_in_79_AD" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">The disputed date of the Vesuvius eruption &mdash; Wikipedia</a></li>
      <li id="src-xi"><span className="text-muted/50 mr-2">xi.</span><a href="https://en.wikipedia.org/wiki/Mus%C3%A9e_des_Beaux_Arts_(poem)" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">W. H. Auden, &ldquo;Mus&eacute;e des Beaux Arts&rdquo; (1938) &mdash; Wikipedia</a></li>
