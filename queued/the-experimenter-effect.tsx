...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Experimenter%20Effect&category=Essay&color=violet&readTime=14%20min&v=2",
        width: 1200,
        height: 630,
