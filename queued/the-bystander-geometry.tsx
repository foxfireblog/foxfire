...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Bystander%20Geometry&category=Essay&color=indigo&readTime=13%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheBystanderGeometry() {
  return (
    ...
    >
      ...
      <p>On March 27, 1964, the <em>New York Times</em> printed a headline that social psychology has been arguing with ever since: &ldquo;38 Who Saw Murder Didn&apos;t Call the Police.&rdquo; Martin Gansberg&apos;s article counted thirty-eight witnesses who allegedly watched Kitty Genovese die on a sidewalk in Queens and did nothing.<sup><a href="#src-i" className="text-muted/50 hover:text-foreground no-underline transition-colors">i</a></sup> The number detonated something in the American psyche. It became proof of what we had always feared about ourselves: that civilization is a thin film over something cold. That we are, at bottom, a species that watches.</p>

      <p>The same number arrives again, like a rhyme: twenty-nine years later, on February 12, 1993, two ten-year-old boys abducted two-year-old James Bulger from a shopping center in Merseyside, England, and walked him 2.5 miles through busy streets to his death. The number of people who saw them? Thirty-eight. The &ldquo;Liverpool 38,&rdquo; the press called them, echoing a vocabulary of shame that had been rehearsed since 1964. As if the universe were running the same experiment twice, adjusting variables, checking its work.</p>
      ...
      <p>The distance is not entirely a disadvantage. From out here the sixty-year argument looks less like a verdict on human character and more like a long confusion about what was being measured. Darley and Latané did not discover that people are callous. They discovered that people are exquisitely dependent on each other for the answer to a prior question: <em>is this actually happening?</em></p>
      ...
      <li id="src-vii"><span className="text-muted/50 mr-2">vii.</span>Death of Hugo Alfredo Tale-Yax (2010), Jamaica, Queens &mdash; contemporaneous reporting on the stabbing and the surveillance footage of passersby. (No stable public link retained.)</li>
