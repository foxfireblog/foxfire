...
export default function TheFastingGirls() {
  return (
    ...
    >
      ...
      <h2>The Watching Was the Point</h2>

      <p>Set the cases side by side and the common element is not hunger. It is surveillance. Each of these girls was placed under an apparatus of observation&mdash;clergy, physicians, committees, ticketed visitors, hired nurses working in shifts&mdash;built on the assumption that sufficient watching would resolve the question. The apparatus never resolved anything. It only converted a private refusal into a public event, and then required the event to continue. The fiercest power available to a person stripped of every other form of agency is <em>no</em>, and the surest way to make that <em>no</em> permanent is to gather an audience for it.</p>
      ...
      <li id="src-ii"><span className="text-muted/50 mr-2">ii.</span><a href="https://en.wikipedia.org/wiki/Ann_Moore_(impostor)" target="_blank" rel="noopener noreferrer" className="underline decoration-muted/30 hover:text-foreground hover:decoration-foreground/50 transition-colors">Ann Moore, the fasting-woman of Tutbury, and her exposure in 1813 (Wikipedia)</a></li>
      ...
      <li id="src-v"><span className="text-muted/50 mr-2">v.</span><span className="text-muted/60">Abram H. Dailey, <em>Mollie Fancher, The Brooklyn Enigma</em> (Eagle Book Printing Department, 1894)</span></li>
