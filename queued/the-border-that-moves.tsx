...
export default function TheBorderThatMoves() {
  return (
    ...
    >
      ...
      <h2>Confined to Its Proper Banks</h2>

      <p>The people of Río Rico are the ones who stay with me. Live your whole life in one country and then learn you were born in another. Learn that your nationality depended on a canal an irrigation company dug illegally in 1906, or a flood that arrived while your great-grandparents slept, or the rate at which silt settled on a bank nobody was watching. Rate. Speed. The entire legal architecture of sovereignty over the Rio Grande turned on whether dirt moved fast or slow.</p>
