...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/og?title=The%20Great%20Guano%20Rush&category=Essay&color=amber&readTime=12%20min&v=2",
        width: 1200,
        height: 630,
...
export default function TheGreatGuanoRush() {
  return (
    ...
    >
      ...
      <p>The Inca counterpoint is the part that will not let go. Here was proof, standing for centuries before Humboldt ever pocketed a sample, that the resource could be used without being destroyed&mdash;that sustainability was not a modern invention but an old administrative practice, enforced with the full seriousness of a state that would execute you for landing on the wrong island in the wrong month. The Inca did not lack ambition or appetite. They simply held that the cormorant outranked the last wheelbarrow load. We knew better and did worse, and the record of knowing better was sitting right there in the imperial law the conquistadors rode past.</p>

      <p>On the Chincha Islands the deposit had stood a hundred and fifty to two hundred feet deep, laid down grain by grain across thousands of years in a place where it essentially never rains. It was gone in about forty. What is out there now is bare rock, and on the bare rock, birds: cormorants and boobies and pelicans packed shoulder to shoulder, doing precisely what they were doing the morning Humboldt came off the boat at Callao and could not breathe. They are rebuilding it. They have been rebuilding it since roughly the year the market collapsed, at the pace birds work, which is the only pace at which the stuff has ever actually been made. Peru now takes twenty-one thousand tons a year and leaves the breeding season alone. At that rate the arrangement could run indefinitely, which is what the Inca meant, and which took everybody else a century and a half, two wars, and a hundred and thirty thousand indentured men to arrive at independently.</p>
